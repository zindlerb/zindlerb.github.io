...
(function (window, $, undefined) {
    ...
    */
    ...
    window.zpicker = {
      pickers: {},
      colors: {},
      add: function(name,defaultColor){
        var self = this;
        if(name in this.pickers){

        } else {
          this.colors[name] = defaultColor || "red";
          this.pickers[name] = function(color){
                                            var hex = color.toHexString();
                                            $("#" + name + "HEX").text(hex);
                                            self.colors[name] = hex;
                                        }
        }
        return this.colors[name];
      },
      zPickersOn: false,
      toggleZPickers: function(){
          var self = this;

          this.zPickersOn = !this.zPickersOn;

          if(this.zPickersOn){

           $("body").append($("#appContent").children());
           $("#zpickerOutMost").remove();
